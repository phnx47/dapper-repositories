...
namespace MicroOrm.Dapper.Repositories.Tests.Tests
{
    public class SqlGeneratorTests
    {
        ...
        [Fact]
        public void MySqlSelectById()
        {
            ISqlGenerator<Address> sqlGenerator = new SqlGenerator<Address>(ESqlConnector.MySQL, false);
